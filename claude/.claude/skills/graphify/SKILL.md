---
name: graphify
description: Build a persistent knowledge graph from code, docs, papers, images, audio, video, or URLs. Use when the user invokes /graphify or asks to map a corpus into clustered communities, GraphRAG-ready JSON, interactive HTML, Obsidian/Neo4j exports, graph queries, shortest paths, or node explanations.
---
