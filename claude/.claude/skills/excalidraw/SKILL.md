---
name: excalidraw
description: Create and edit Excalidraw diagrams programmatically in .excalidraw JSON format. Use when the user asks for diagrams, flowcharts, architecture maps, wireframes, hand-drawn visual explanations, or modifications to existing Excalidraw files.
---
