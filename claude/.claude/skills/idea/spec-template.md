...
Plantilla canónica que el skill `/idea` debe usar al escribir cualquier spec nuevo. Las 20 secciones son obligatorias y deben aparecer en este orden. No se eliminan secciones: si una sección no aplica, se deja con la nota `No aplica — <razón>` (no se omite).
