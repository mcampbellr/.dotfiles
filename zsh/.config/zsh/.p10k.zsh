# Generated by Powerlevel10k configuration wizard on 2022-02-24 at 16:06 CST.
...
() {
  ...
  function prompt_user_rotator () {
    FILENAME="$HOME/.local/share/rotator/.rotator.json"
    env=`cat "$FILENAME" | jq -r .currentEnv`
    p10k segment -f "\u001b[0m" -i "" -t "$env"
  }
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION='VIM'
